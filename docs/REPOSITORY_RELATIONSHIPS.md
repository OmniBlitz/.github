...
# Repository relationships for `OmniBlitz`
...
- Inventory digest: `sha256:9431b9145e81c4910173e14e20acc11624531b524aa960f904e5ab836376a39d`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:omniblitz` |
| GitHub owner ID | `311152709` |
| Linear project ID | `179cf0a3-8865-4d3d-9f33-11ebf2b8534e` |
...
|---|---|---|---|
| `OmniBlitz/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
