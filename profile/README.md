...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`OmniBlitz`](https://github.com/OmniBlitz) GitHub owner.

Planning and delivery context is tracked in [github.com/OmniBlitz](https://linear.app/denman/project/githubcomomniblitz-b6c7bba447b0). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/OmniBlitz/.github).
