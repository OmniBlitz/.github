# OmniBlitz organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`OmniBlitz`](https://github.com/OmniBlitz).

## Canonical organization links

- GitHub organization: https://github.com/OmniBlitz
- Public organization defaults: https://github.com/OmniBlitz/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomomniblitz-b6c7bba447b0
...
`OmniBlitz` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
